...
from ..interfaces import (
    LLMProvider, ChatMessage, ChatResponse, ModelConfig, MessageRole
)
...
class AnthropicLLMAdapter(LLMProvider):
    ...
    def _convert_messages_to_anthropic(self, messages: List[ChatMessage]) -> tuple[List[Dict[str, str]], Optional[str]]:
