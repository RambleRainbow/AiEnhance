...
class GraphitiAdapter(MemorySystem):
    ...
    def _convert_graphiti_result_to_entry(self, graphiti_result, user_context: UserContext) -> Optional[MemoryEntry]:
    ...
    def _convert_graphiti_node_to_entry(self, node, user_context: UserContext) -> Optional[MemoryEntry]:
