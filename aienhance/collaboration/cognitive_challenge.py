...
class CognitiveChallenge(CognitiveChallenger):
    ...
    async def _analyze_reasoning(self, content: str, user_reasoning: str | None) -> dict[str, Any]:
        """分析用户的推理过程"""
        prompt = f"""
请分析以下内容中的推理过程：
...
"""
    ...
    async def _generate_challenge_by_type(self, request: ChallengeRequest,
                                        ...
                                        challenge_type: ChallengeType) -> Challenge | None:
        """根据类型生成特定挑战"""
    ...
    async def _generate_assumption_challenge(self, request: ChallengeRequest,
                                           reasoning_analysis: dict[str, Any]) -> Challenge | None:
        """生成假设质疑挑战"""
