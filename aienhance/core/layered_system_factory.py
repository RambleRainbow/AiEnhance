...
class LayeredSystemFactory:
    ...
    def create_layered_system(
        ...
        try:
            ...
            if memory_config:
                try:
                    memory_system = MemorySystemFactory.create_memory_system(
                        memory_config, llm_provider
                    )
            ...
            system = LayeredCognitiveSystem(
                config=config, memory_system=memory_system, llm_provider=llm_provider
            )
    ...
    def create_creative_layered_system(
        ...
        creative_config = {
            ...
            "enable_collaboration": True,
            "perception": {"creativity_bias": 0.8, "open_ended_preference": True},
            "cognition": {
                "memory_activation": {
                    "surface_weight": 0.3,
                    "deep_weight": 0.3,
    ...
    def create_lightweight_layered_system(
        ...
        lightweight_config = {
            ...
            "cognition": {
                ...
                "semantic_enhancement": {"basic_gap_filling": True},
                "analogy_reasoning": {"simple_analogies": True},
            },
            "behavior": {
                "adaptive_output": {
                    "default_density": "medium",
    ...
    def create_from_enhanced_factory_config(
        ...
        **kwargs,
        ...
        try:
            ...
            logger.error(
                f"Failed to create layered system from enhanced factory config: {e}"
            )
            raise
    ...
    def get_available_system_types() -> list[str]:
        """获取可用的系统类型"""
        return ["educational", "research", "creative", "lightweight", "default"]
